...
<mark style="color:orange;">**Quick Scan**</mark><mark style="color:orange;">:</mark> A faster option that focuses on key artefact types and provides quick insights into major evidence categories. \
...
Once an attacker gains access to a Windows system, they often attempt to escalate privileges to gain full control: \
...
<mark style="color:orange;">**Remote Execution Tools**</mark><mark style="color:orange;">:</mark> Check for the use of remote execution tools like PsExec, WMI, or PowerShell for unauthorised access.
...
<mark style="color:orange;">**Malicious Scripts**</mark><mark style="color:orange;">:</mark> Investigate the use of PowerShell or batch scripts for executing malware or maintaining persistence. \
...
<mark style="color:orange;">**Patching Vulnerabilities**</mark><mark style="color:orange;">:</mark> Identify and patch security vulnerabilities that were exploited during the attack. \
